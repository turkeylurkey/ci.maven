...
public class DevTest extends BaseDevTest {
   ...
   public void configChangeTest() throws Exception {
      Thread.sleep(91000);
      writeInConsole("configChangeTest");
   ...
   public void configIncludesChangeTest() throws Exception {
      Thread.sleep(91000);
      writeInConsole("configIncludesChangeTest");
   ...
   public void resourceFileChangeTest() throws Exception {
      Thread.sleep(91000);
      writeInConsole("resourceFileChangeTest");
   ...
   public void testDirectoryTest() throws Exception {
      Thread.sleep(91000);
      writeInConsole("testDirectoryTest");
   ...
   public void manualTestsInvocationTest() throws Exception {
      writeInConsole("manualTestsInvocationTest");
      Thread.sleep(91000);
      writeInConsole(""); // Just enter
   ...
   public void restartServerTest() throws Exception {
      Thread.sleep(91000);
      writeInConsole("restartServerTest");
      ...
      writeInConsole("r"); // command to restart liberty
    ...
    public void invalidDependencyTest() throws Exception {
      Thread.sleep(91000);
      writeInConsole("invalidDependencyTest");
   ...
   public void resolveDependencyTest() throws Exception {      
      Thread.sleep(91000);
      writeInConsole("resolveDependencyTest");
   ...
   public void generateFeatureTest() throws Exception {
      Thread.sleep(91000);
      writeInConsole("generateFeatureTest");
      ...
      boolean bb = verifyLogMessageExists(errMsg, 15000, errCount+1);
      assertTrue(getLogTail(), bb); // wait for compilation
